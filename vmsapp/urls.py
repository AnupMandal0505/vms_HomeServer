...
urlpatterns = [
    path('appointments/', include('vmsapp.appoint_router')),  # Assuming vmsapp/router.py has its own router setup
    path('notification/', include('vmsapp.notification_router')),  # Assuming vmsapp/router.py has its own router setup
    path('', include('vmsapp.canteen_router')),  # Assuming vmsapp/router.py has its own router setup
